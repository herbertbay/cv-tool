...
function AtsMatchContent() {
  ...
  const [step, setStep] = useState<'form' | 'auth_required' | 'score' | 'optimized'>('form');
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="mx-auto max-w-3xl px-6 py-12">
        ...
        <p className="text-slate-600 mb-8">
          Upload your CV and the job description to see how well you match. Sign in to view your score and get an optimized version.
        </p>
        ...
        {step === 'auth_required' && (
          <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            <div className="text-center">
              ...
              <p className="mt-2 text-slate-600">Sign in to view it and see how much you can improve.</p>
          ...
          <div className="space-y-6">
            <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="mt-2 text-slate-600">
                Your original score was {optimizeData.original_score}. With Optimal CV you can create a CV tailored to each job and get similar improvements.
              </p>
              <Link
                href="/"
