...
function AtsMatchForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (user) {
        router.push(`/ats-match/score?result_token=${encodeURIComponent(result_token)}`);
      } else {
        router.push(`/ats-match/sign-in?result_token=${encodeURIComponent(result_token)}`);
      }
    } catch (e) {
